...
// the reflection and refraction color using  result of the fresnel equations (it computes
// the amount of reflection and refractin depentheding on the surface normal, incident view direction
